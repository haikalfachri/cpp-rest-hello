        ...
        while (true) {
            ...
            if (pub_port != sub_port) {
                ...
                if (method == postMethod) {
                    txn.exec("INSERT INTO users (name, created_at, updated_at) VALUES ('" + user.name + "', '" +
